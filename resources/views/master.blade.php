...
<head>
  ...
  initial-scale=1.0">
    ...
    <title>NINER WEB CLOTHING STORE</title>
        ...
        <div class="container-fluid">
            <div class="me-5">
                <a class="navbar-brand" href="{{route('dashboard')}}">
                    <img src="/assets/img/img12.jpg" alt="Logo" width="60" height="54" class="d-inline-block align-text-top">
                    <b class="fs-3">Clothing NINER</b>
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-5 me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/produk/tampil">Produk</a>
                    </li>
                    <li class="nav-item">
